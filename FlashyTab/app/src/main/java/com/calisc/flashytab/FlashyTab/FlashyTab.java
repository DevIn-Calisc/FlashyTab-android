package com.calisc.flashytab.FlashyTab;
...
public class FlashyTab extends ViewPager.SimpleOnPageChangeListener {
    ...
    public FlashyTab(TabLayout tabLayout) {
